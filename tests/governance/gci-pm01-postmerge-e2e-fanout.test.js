...
test("Q011 is the single current shared-path owner and Q010 is demoted to owned paths only",()=>{
  ...
  assert.match(text,/name: P07F W7 Q011 Post-Merge Pages E2E/);
  assert.match(text,/node tools\/curriculum\/run-p07f-w7-q011-live-pages-e2e\.mjs/);
  assert.ok(policy.historicalCutoverWorkflows.includes(".github/workflows/p07f-w7-q010-live-pages-e2e.yml"));
