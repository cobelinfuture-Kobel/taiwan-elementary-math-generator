...
const CURRENT_VISIBLE_KP_COUNT = 79;
...
function worksheet(kpId, groupId, count = 8) {
  return buildBatchABrowserWorksheetDocument({ sourceId, selectionMode: BATCH_A_RESOLVER_SELECTION_MODES.SINGLE_KNOWLEDGE_POINT, selectedKnowledgePointIds: [kpId], selectedPatternGroupIds: [groupId], questionCount: count, generationSeed: `s43g5-${kpId}`, includeAnswerKey: true });
}
...
test("S43G5F zero-middle multiplication generates 3-digit zero-ten by 1-digit", () => {
