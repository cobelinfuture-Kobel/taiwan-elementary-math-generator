...
test("P03F39 historical authority is exactly 32/237 while current Pixel advances through Slice046 to 33/247", () => {
  ...
  assert.equal(pixel.bySourceId[G5B_U04_P03F39_SOURCE_ID].visibleKnowledgePoints.length, 3);
