...
test("Q016 current pointers and bounded validation",()=>{
  ...
  assert.match(s,/batch-a-selector-p07f17-extension/);assert.match(b,/public-ui-capability-binding-p07f17/);for(const id of ["17","16","15","14","13","12","11","10","09","08","07","06","05","04","03","02","01"])assert.match(g,new RegExp("requestsP07F"+id));for(const id of ["17","16","15","14","13","12","11","10","09","08","07","06","05","04","03","02","01"])assert.match(w,new RegExp("buildP07F"+id+"Worksheet"));
