...
test("W7 Q004 executable R04 and R05 mapping match frozen geometry-formula envelope",()=>{
  ...
  assert.deepEqual(r04.appliedModifierIds,p.runtimeCapabilityAuthority.predictedAppliedModifierIds);
  assert.deepEqual(r04.requiredRuntimeCapabilityIds,p.runtimeCapabilityAuthority.predictedRequiredRuntimeCapabilityIds);
  assert.deepEqual(r04.optionalRuntimeCapabilityIds,p.runtimeCapabilityAuthority.predictedOptionalRuntimeCapabilityIds);
