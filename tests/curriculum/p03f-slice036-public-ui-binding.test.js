...
test("P03F36 current Classic Pixel query-state and worksheet consumers point to P03F39 successors",()=>{assert.match(sourceText("site/assets/browser/public-capability-ui.js"),/public-ui-capability-binding-p03f40\.js/);assert.match(sourceText("site/assets/browser/state/public-pattern-group-selection.js"),/batch-a-selector-p03f40-extension\.js/);assert.match(sourceText("site/assets/browser/state/query-state.js"),/batch-a-selector-p03f40-extension\.js/);assert.match(sourceText("site/pixel/pixel-public-capability-ui.js"),/public-ui-capability-binding-p03f40\.js/);assert.match(sourceText("site/pixel/pixel-registry-bridge.js"),/batch-a-selector-p03f40-extension\.js/);assert.match(sourceText("site/modules/curriculum/registry/batch-a-selector-extension.js"),/batch-a-selector-p03f40-extension\.js/);assert.match(sourceText("site/modules/curriculum/batch-a/batch-a-browser-worksheet-r2e-entry.js"),/batch-a-browser-worksheet-p03f40-extension\.js/);});
