...
test("Q020 current pointers and bounded validation are successor-safe",()=>{
  ...
  assert.match(s,/batch-a-selector-p07f20-extension/);assert.match(b,/public-ui-capability-binding-p07f20/);
  for(const id of ["20","19","18","17","16","15","14","13","12","11","10","09","08","07","06","05","04","03","02","01"])assert.match(g,new RegExp("requestsP07F"+id));
  for(const id of ["20","19","18","17","16","15","14","13","12","11","10","09","08","07","06","05","04","03","02","01"])assert.match(w,new RegExp("buildP07F"+id+"Worksheet"));
