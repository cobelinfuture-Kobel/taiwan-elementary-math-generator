...
test("W7 Q001 remains reachable after current browser pointers advance to P07F04",()=>{
  ...
  assert.match(selectorText,/batch-a-selector-p07f04-extension/);assert.match(bindingText,/public-ui-capability-binding-p07f04/);
  assert.match(generatorText,/requestsP07F04/);assert.match(generatorText,/requestsP07F03/);assert.match(generatorText,/requestsP07F02/);assert.match(generatorText,/requestsP07F01/);assert.match(generatorText,/requestsP06F20/);assert.match(worksheetText,/buildP07F04Worksheet/);assert.match(worksheetText,/buildP07F03Worksheet/);assert.match(worksheetText,/buildP07F02Worksheet/);assert.match(worksheetText,/buildP07F01Worksheet/);assert.match(worksheetText,/buildP06F20Worksheet/);
});
