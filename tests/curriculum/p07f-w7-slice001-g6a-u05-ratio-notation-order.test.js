...
test("W7 Q001 current browser pointers advance to P07F01 while W6 Q020 stays reachable",()=>{
  ...
  assert.match(selectorText,/batch-a-selector-p07f01-extension/);assert.match(bindingText,/public-ui-capability-binding-p07f01/);
  assert.match(generatorText,/requestsP07F01/);assert.match(generatorText,/requestsP06F20/);assert.match(worksheetText,/buildP07F01Worksheet/);assert.match(worksheetText,/buildP06F20Worksheet/);
});
