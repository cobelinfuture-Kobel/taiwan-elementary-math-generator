...
test("W7 Q006 current browser pointers advance to P07F06 while Q005 Q004 Q003 Q002 Q001 and W6 Q020 stay reachable",()=>{
  ...
  for(const id of ["06","05","04","03","02","01"])assert.match(generatorText,new RegExp("requestsP07F"+id));
  assert.match(generatorText,/requestsP06F20/);for(const id of ["06","05","04","03","02","01"])assert.match(worksheetText,new RegExp("buildP07F"+id+"Worksheet"));assert.match(worksheetText,/buildP06F20Worksheet/);
});
