...
test("P03F39 current Pixel registry advances through Slice052 to 34/258 and G5B-U04 contains q031 q039 q045 plus q049 application and estimation",()=>{
  const registry=getCurrentPixelRegistrySnapshot();
  assert.deepEqual([registry.sourceCount,registry.visibleKnowledgePointCount],[34,258]);
