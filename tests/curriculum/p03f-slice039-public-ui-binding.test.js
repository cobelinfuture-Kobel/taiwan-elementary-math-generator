...
test("P03F39 current Pixel registry advances through Slice046 to 33/247 and G5B-U04 contains q031 q039 plus q045",()=>{
  const registry=getCurrentPixelRegistrySnapshot();
  assert.deepEqual([registry.sourceCount,registry.visibleKnowledgePointCount],[33,247]);
