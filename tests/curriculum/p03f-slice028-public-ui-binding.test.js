...
test("P03F28 historical selector remains 219 while current public inventory advances through Slice033 to 32 sources / 229 KPs",()=>{
  ...
  assert.equal(pixel.visibleKnowledgePointCount, 229);
