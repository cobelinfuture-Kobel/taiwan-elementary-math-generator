...
test("P03F28 historical selector remains 219 while current public inventory advances through Slice044 to 33 sources / 245 KPs",()=>{
  ...
  assert.equal(pixel.bySourceId[G5A_U01_SOURCE_ID].visibleKnowledgePointCount,7);
});
