...
test("P03F25 current Pixel projection preserves two G4A-U06 KPs while current public total advances through Slice030 to 224", () => {
  ...
  assert.equal(snapshot.visibleKnowledgePointCount, 224);
