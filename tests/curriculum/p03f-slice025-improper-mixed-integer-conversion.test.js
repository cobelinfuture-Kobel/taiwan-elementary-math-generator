...
test("P03F25 current Pixel projection preserves two G4A-U06 KPs while current public total advances through Slice029 to 220", () => {
  ...
  assert.equal(snapshot.visibleKnowledgePointCount, 220);
