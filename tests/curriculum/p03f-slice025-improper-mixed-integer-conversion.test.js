...
test("P03F25 historical two-KP projection remains intact while current G4A-U06 advances through q027 to six", () => {
  ...
  assert.equal(snapshot.bySourceId[sourceId].visibleKnowledgePoints.length, 6);
});
