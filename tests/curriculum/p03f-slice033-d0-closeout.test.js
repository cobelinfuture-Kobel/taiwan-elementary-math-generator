...
test("P03F33 historical selector remains exactly 32 sources / 229 KPs while current Pixel advances through reconciled Slice042 to 241 KPs", () => {
  ...
  assert.equal(pixel.visibleKnowledgePointCount, 241);
