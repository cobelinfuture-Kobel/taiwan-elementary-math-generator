...
test("P03F33 pattern-group state remains intact while current Pixel registry advances through Slice037 to 32 sources / 235 KPs", () => {
  for (const knowledgePointId of G4A_U06_P03F33_KP_IDS) {
  ...
  assert.equal(snapshot.visibleKnowledgePointCount, 235);
