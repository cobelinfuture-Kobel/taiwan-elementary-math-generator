...
GOAL_DISTANCE_AFTER  = D1_GLOBAL_CONTEXT_ARCHITECTURE_AND_TASK_CHAIN_LOCKED_PENDING_CI
DISTANCE_REDUCED     = 全域 ownership、查證邊界、遷移來源、領域與 S00–S14 路徑已 materialize
