# S57F7R1 G3B-U04 Human Semantic Readback QA FullFix
...
The FullFix treats the following as blocking:

1. two batch quantities are not separately identified;
2. a named participant is not clearly included in the stated participant total;
3. a price-equivalence chain omits the compared price dimension;
4. a production chain does not state one common time period;
5. a classifier and object noun collide or duplicate;
6. the answer unit does not match the requested semantic quantity;
