...
```text
W02 canonical operation authority
...
DISTANCE_REDUCED     = The fifth W2 shared foundation now executes both authoritative quantity-times-integer KnowledgePoints across three sources: exact fraction or mixed-number scaling with explicit source-declared unit binding and whole-number mass scaling across four canonical units. All five W2 foundations are production admitted.
