...
Chromium PDF witnesses      = 4 / 4 PASS
overflow findings           = 0
live UI source smokes       = 3 / 3 PASS
public source options       = 19
```

Every visible PatternGroup attached to the four protected KnowledgePoints was exercised independently through the public selector, R07 Global Primary authority, shared generator and validator, answer-key, production HTML renderer, Chromium A4 PDF and live UI print path.

## Exact protected witnesses

| KnowledgePoint | Source | PatternGroup | PatternSpecs | Questions | Answer keys | PDF bytes | Overflow |
|---|---|---|---:|---:|---:|---:|---:|
| `kp_g3a_u01_digit_arrangement_max_min` | `g3a_u01_3a01` | `pg_g3a_u01_digit_arrangement_max_min` | 3 | 2 | 2 | 18799 | 0 |
| `kp_g4a_u01_boundary_number_difference` | `g4a_u01_4a01` | `pg_g4a_u01_boundary_number_difference` | 1 | 2 | 2 | 15740 | 0 |
| `kp_g4a_u01_missing_digit_comparison_extreme_digit` | `g4a_u01_4a01` | `pg_g4a_u01_missing_digit_comparison_extreme_digit` | 1 | 2 | 2 | 17058 | 0 |
| `kp_g4b_u01_trailing_zero_division_remainder_restore` | `g4b_u01_4b01` | `pg_g4b_u01_trailing_zero_division_remainder_restore` | 1 | 2 | 2 | 17500 | 0 |
...
shared generator / validator sweep       = 4 / 4 PASS
answer-key / HTML / print-layout sweep   = 4 / 4 PASS
...
```text
DISTANCE_SHORTENED = 4 protected D0 rows moved from compatibility-revalidation pending to compatibility revalidated while preserving their existing admissions.
SYSTEM_NODE_ADVANCED = P03C Capability-Unblocked Matrix → Public Product Pipeline → P03D Protected D0 Compatibility Revalidation.
BLOCKERS_REMOVED = [post-W3 per-pattern generator, validator, answer-key, HTML, PDF, print and live-UI compatibility proof for four protected D0 rows]
NEW_BLOCKERS = []
```
