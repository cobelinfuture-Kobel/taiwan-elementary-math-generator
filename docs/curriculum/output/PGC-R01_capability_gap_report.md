...
```text
PUBLIC_SOURCES                    = 29
VISIBLE_KNOWLEDGE_POINTS          = 207
VISIBLE_KP_SURFACE_ACCOUNTED      = 621 / 621
VISIBLE_KP_SURFACE_CAPABILITY     = 587
VISIBLE_KP_SURFACE_EXPLICIT_GAP   = 34
CAPABILITY_ROWS                   = 1312
UNIQUE_PATTERN_GROUPS             = 262
UNIQUE_PATTERN_SPECS              = 381
UI_OPTIONS_ACCOUNTED              = 165 / 165
BLOCKING_R01_GAPS                 = 0
R02_UI_BINDING_GAPS               = 56
R03_CAPACITY_UNVERIFIED           = 1312
```
...
1. All 29 public sources and all 207 visible KnowledgePoints are accounted across all three public surfaces.
