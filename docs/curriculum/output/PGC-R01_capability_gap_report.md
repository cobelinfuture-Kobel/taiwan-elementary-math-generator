...
```text
PUBLIC_SOURCES                    = 30
VISIBLE_KNOWLEDGE_POINTS          = 224
VISIBLE_KP_SURFACE_ACCOUNTED      = 672 / 672
VISIBLE_KP_SURFACE_CAPABILITY     = 638
VISIBLE_KP_SURFACE_EXPLICIT_GAP   = 34
CAPABILITY_ROWS                   = 1410
UNIQUE_PATTERN_GROUPS             = 283
UNIQUE_PATTERN_SPECS              = 417
UI_OPTIONS_ACCOUNTED              = 165 / 165
BLOCKING_R01_GAPS                 = 0
R02_UI_BINDING_GAPS               = 56
R03_CAPACITY_UNVERIFIED           = 1410
```
...
1. All 30 public sources and all 224 visible KnowledgePoints are accounted across all three public surfaces.
2. All 165 visible question-type UI options map to at least one capability row.
