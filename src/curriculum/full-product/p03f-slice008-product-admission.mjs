...
import { validateBatchABrowserPlan, validateBatchABrowserQuestions } from "../../../site/modules/curriculum/batch-a/batch-a-browser-validator-p03f8.js";
...
export function materializeP03FSlice008ProductAdmission() {
  const authority = readJson("slice008-decimal-compose-decompose-authority.json");
  const manifest = readJson("slice008-product-admission.manifest.json");
