...
const preflight = JSON.parse(fs.readFileSync(
  path.join(ROOT, "data/curriculum/full-product/p05f/q005-g4b-u10-cubic-centimeter-unit-source-authority-preflight.json"),
  "utf8",
));
...
const report = {
  schemaName: "P05FW5Q005SourceAuthorityPreflightReadbackV1",
  ...
  includedRelations: preflight.q005ScopeLock.includedRelations,
  excludedKnowledgePointIdsFromSameSource: preflight.q005ScopeLock.excludedKnowledgePointIdsFromSameSource,
