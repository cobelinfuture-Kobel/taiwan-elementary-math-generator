...
const marker = "PGC-R06 A04 derive current queue from A03 capacity lineage";
...
console.log(`PGC_R06_A04_STALE_QUEUE_BASELINE_FIX=${JSON.stringify({
  ...
  a03LineageRouteAuthorityBaseline: 98,
  a03MetadataRepaired: true,
