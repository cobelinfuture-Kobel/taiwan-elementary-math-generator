...
const preflight = JSON.parse(fs.readFileSync(
  path.join(ROOT, "data/curriculum/full-product/p05f/q007-g5a-u10a-solid-shape-classification-source-authority-preflight.json"),
  "utf8",
));
...
const report = {
  schemaName: "P05FW5Q007SourceAuthorityPreflightReadbackV1",
  ...
  includedRelations: preflight.q007ScopeLock.includedRelations,
  excludedKnowledgePointIdsFromSameSource: preflight.q007ScopeLock.excludedKnowledgePointIdsFromSameSource,
