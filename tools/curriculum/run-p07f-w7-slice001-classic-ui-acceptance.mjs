...
const PROTECTED=["kp_g6a_u05_ratio_value","kp_g6a_u05_equivalent_ratio","kp_g6a_u05_simplify_ratio","kp_g6a_u05_ratio_partition_application"];
const COUNT=9;
...
async function run(){
  ...
  if(selector.sourceId!==SOURCE||!selector.targetPresent||!selector.protectedAbsent||!selector.sameUnitDisabled)throw new Error("P07F01_SELECTOR:"+JSON.stringify(selector));
