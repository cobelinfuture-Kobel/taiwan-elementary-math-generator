...
const ROOT = resolve("docs/curriculum/output/g4b-u04-r3c-approved-layouts");
const MATRIX_PATH = resolve(ROOT, "matrix-manifest.json");
const RENDER_ROOT = "/tmp/g4b-u04-r3c-approved-layouts";
...
run("node", ["tools/curriculum/generate-g4b-u04-r3c-approved-layouts.mjs"]);
...
root = Path('docs/curriculum/output/g4b-u04-r3c-approved-layouts')
render_root = Path('/tmp/g4b-u04-r3c-approved-layouts')
...
for scenario in matrix['scenarios']:
    ...
    bbox = Path('/tmp') / f"{scenario['scenarioId']}-bbox.html"
