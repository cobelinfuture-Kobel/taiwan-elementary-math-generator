...
const preflight = JSON.parse(fs.readFileSync(
  path.join(ROOT, "data/curriculum/full-product/p05f/q010-g3a-u05-right-angle-recognition-source-authority-preflight.json"),
  "utf8",
));
...
const report = {
  schemaName: "P05FW5Q010SourceAuthorityPreflightReadbackV1",
  ...
  includedRelations: preflight.q010ScopeLock.includedRelations,
  excludedKnowledgePointIdsFromSameSource: preflight.q010ScopeLock.excludedKnowledgePointIdsFromSameSource,
