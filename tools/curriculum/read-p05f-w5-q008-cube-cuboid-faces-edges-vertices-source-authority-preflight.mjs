...
const preflight = JSON.parse(fs.readFileSync(
  path.join(ROOT, "data/curriculum/full-product/p05f/q008-g5a-u10a1-cube-cuboid-faces-edges-vertices-source-authority-preflight.json"),
  "utf8",
));
...
const report = {
  schemaName: "P05FW5Q008SourceAuthorityPreflightReadbackV1",
  ...
  includedRelations: preflight.q008ScopeLock.includedRelations,
  excludedKnowledgePointIdsFromSameSource: preflight.q008ScopeLock.excludedKnowledgePointIdsFromSameSource,
  ...
  sourceIdentityAnomalyAcknowledged: preflight.preflightDecision.sourceIdentityAnomalyAcknowledged,
