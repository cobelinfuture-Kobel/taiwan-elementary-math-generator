...
export const G4B_U01_PRODUCTION_PROMOTION_ACTIVATION = Object.freeze({
  status: "canonical_worksheet_renderer_integrated_public_controls_qa_pending",
...
export function validateG4BU01ProductionPromotionProjection() {
  ...
  if (G4B_U01_PRODUCTION_PROMOTION_ACTIVATION.resolverBehaviorChanged !== false) errors.push("resolver_changed");
  if (G4B_U01_PRODUCTION_PROMOTION_ACTIVATION.canonicalRouterChanged !== false) errors.push("router_changed");
  if (G4B_U01_PRODUCTION_PROMOTION_ACTIVATION.publicPrintControlBehaviorChanged !== false) errors.push("print_controls_changed_too_early");
