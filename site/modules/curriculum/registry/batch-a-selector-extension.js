...
import * as current from "./batch-a-selector-p03f10-extension.js";

// Earlier inventory milestones run in Node and retain the exact P01E selector snapshot.
// The actual Classic browser consumes the bounded P03F10 successor without mutating those histories.
...
export function resolveVisiblePatternSpecIdsForKnowledgePoint(knowledgePointId) { return currentBrowserSelectorActive() ? current.resolveVisiblePatternSpecIdsForKnowledgePoint(knowledgePointId) : historical.resolveVisiblePatternSpecIdsForKnowledgePoint(knowledgePointId); }
export {
