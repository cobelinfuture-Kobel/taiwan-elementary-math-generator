...
export const G3B_U05_P05F23_PATTERN_SPECS=Object.freeze([
  Object.freeze({patternSpecId:"ps_g3b_u05_area_conservation_cut_translate",knowledgePointId:KP_CONSERVATION,patternGroupId:GROUP_CONSERVATION,patternFamilyId:"AREA_CONSERVATION",relation:"PRESERVE_AREA_UNDER_CUT_TRANSLATE_OR_REARRANGE_WITHOUT_ADD_OVERLAP_OR_LOSS",transformationMode:"CUT_TRANSLATE",questionMode:"diagram",diagramKind:"area_conservation_irregular_grid_diagram",requiresGeometryDiagramRepresentation:true,requiresGeometryDomainValidator:true,requiresGeometryFormulaEvaluation:true,requiresGeometryPropertyReasoning:true,applicationAllowed:false}),
  Object.freeze({patternSpecId:"ps_g3b_u05_area_conservation_rearrange",knowledgePointId:KP_CONSERVATION,patternGroupId:GROUP_CONSERVATION,patternFamilyId:"AREA_CONSERVATION",relation:"PRESERVE_AREA_UNDER_CUT_TRANSLATE_OR_REARRANGE_WITHOUT_ADD_OVERLAP_OR_LOSS",transformationMode:"CUT_REARRANGE",questionMode:"diagram",diagramKind:"area_conservation_irregular_grid_diagram",requiresGeometryDiagramRepresentation:true,requiresGeometryDomainValidator:true,requiresGeometryFormulaEvaluation:true,requiresGeometryPropertyReasoning:true,applicationAllowed:false}),
  Object.freeze({patternSpecId:"ps_g3b_u05_irregular_grid_decompose",knowledgePointId:KP_IRREGULAR,patternGroupId:GROUP_IRREGULAR,patternFamilyId:"IRREGULAR_GRID_AREA",relation:"COMPUTE_IRREGULAR_GRID_AREA_BY_DECOMPOSITION_INTO_COUNTABLE_PARTS",solutionMode:"DECOMPOSE",questionMode:"diagram",diagramKind:"area_conservation_irregular_grid_diagram",requiresGeometryDiagramRepresentation:true,requiresGeometryDomainValidator:true,requiresGeometryFormulaEvaluation:true,requiresGeometryPropertyReasoning:true,applicationAllowed:false}),
  Object.freeze({patternSpecId:"ps_g3b_u05_irregular_grid_complete",knowledgePointId:KP_IRREGULAR,patternGroupId:GROUP_IRREGULAR,patternFamilyId:"IRREGULAR_GRID_AREA",relation:"COMPUTE_IRREGULAR_GRID_AREA_BY_COMPLETION_TO_A_KNOWN_TOTAL",solutionMode:"COMPLETE",questionMode:"diagram",diagramKind:"area_conservation_irregular_grid_diagram",requiresGeometryDiagramRepresentation:true,requiresGeometryDomainValidator:true,requiresGeometryFormulaEvaluation:true,requiresGeometryPropertyReasoning:true,applicationAllowed:false}),
  Object.freeze({patternSpecId:"ps_g3b_u05_irregular_grid_partial_cells",knowledgePointId:KP_IRREGULAR,patternGroupId:GROUP_IRREGULAR,patternFamilyId:"IRREGULAR_GRID_AREA",relation:"COMBINE_PARTIAL_GRID_CELLS_BY_ACTUAL_PROPORTION",solutionMode:"PARTIAL_CELLS",questionMode:"diagram",diagramKind:"area_conservation_irregular_grid_diagram",requiresGeometryDiagramRepresentation:true,requiresGeometryDomainValidator:true,requiresGeometryFormulaEvaluation:true,requiresGeometryPropertyReasoning:true,applicationAllowed:false}),
]);
...
export function auditG3BU05P05F23Projection(){const errors=[];if(G3B_U05_P05F23_SELECTOR_ROWS.length!==2||G3B_U05_P05F23_PATTERN_GROUPS.length!==2||G3B_U05_P05F23_PATTERN_SPECS.length!==5||G3B_U05_P05F23_FORMAL_MAPPINGS.length!==2)errors.push("P05F23_CARDINALITY_INVALID");if(new Set(G3B_U05_P05F23_SPEC_IDS).size!==5)errors.push("P05F23_PATTERN_ID_DUPLICATE");if(G3B_U05_P05F23_PATTERN_SPECS.some(row=>row.questionMode!=="diagram"||row.requiresGeometryDiagramRepresentation!==true||row.requiresGeometryDomainValidator!==true||row.requiresGeometryFormulaEvaluation!==true||row.requiresGeometryPropertyReasoning!==true||row.applicationAllowed!==false))errors.push("P05F23_PATTERN_INVARIANT_INVALID");return Object.freeze({ok:errors.length===0,errors:Object.freeze(errors),counts:Object.freeze({knowledgePoints:2,patternGroups:2,patternSpecs:5,diagram:5,application:0})});}
