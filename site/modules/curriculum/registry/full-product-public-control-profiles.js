...
export const CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_IDS = Object.freeze([...P03F3_FULL_PRODUCT_PUBLIC_SOURCE_IDS, ...W3_SLICE004_PUBLIC_SOURCE_IDS]);
...
export function auditFullProductPublicControlProfiles(options = {}) {
  const historicalW3 = options.includeW3Slice001 === true && options.includeW3Slice002 !== true && options.includeW3Slice003 !== true && options.includeW3Slice004 !== true;
  const includeSlice4 = options.includeW3Slice004 === true;
  ...
  for (const sourceId of sourceIds) {
    ...
    const applicationExpected = ["g3b_u07_3b07", "g3b_u09_3b09"].includes(sourceId) ? false : sourceId === "g3a_u08_3a08" ? !historicalW3 : true;
