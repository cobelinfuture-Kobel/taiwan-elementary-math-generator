...
const rows = Object.freeze([
  ...
  [sourceId, "4A-U01", "1億以內的數", "kp_g4a_u01_same_digit_place_value_difference", "pg_g4a_u01_same_digit_place_value_difference", "ps_g4a_u01_same_digit_place_value_difference", "相同數字不同位值差和", "large_number_place_value", ["same_digit", "place_value_difference", "place_value_sum", "eight_digit"], "same_digit_place_value_difference_sum", "reasoning_prompt"],
  [sourceId, "4A-U01", "1億以內的數", "kp_g4a_u01_nonstandard_place_value_composition", "pg_g4a_u01_nonstandard_place_value_composition", "ps_g4a_u01_nonstandard_place_value_composition", "非標準位值組合", "large_number_place_value", ["nonstandard_composition", "count_1_to_99", "place_value"], "nonstandard_place_value_composition", "composition_prompt"],
  [sourceId, "4A-U01", "1億以內的數", "kp_g4a_u01_place_value_card_unit_model_composition", "pg_g4a_u01_place_value_card_unit_model_composition", "ps_g4a_u01_place_value_card_unit_model_composition", "位值卡組合", "large_number_place_value", ["card_model", "composition", "sparse_cards", "place_value"], "place_value_card_composition", "card_model_prompt"],
  ...
  [sourceId, "4A-U01", "1億以內的數", "kp_g4a_u01_large_number_reading_writing_conversion", "pg_g4a_u01_large_number_reading_writing_conversion", "ps_g4a_u01_large_number_reading_writing_conversion", "大數讀寫轉換", "large_number_reading_writing", ["chinese_number", "conversion"], "large_number_read_write", "conversion_prompt"],
  [sourceId, "4A-U01", "1億以內的數", "kp_g4a_u01_numeric_vs_chinese_number_compare", "pg_g4a_u01_numeric_vs_chinese_number_compare", "ps_g4a_u01_numeric_vs_chinese_number_compare", "數字與中文數詞比大小", "large_number_comparison", ["chinese_number", "mixed_notation", "comparison"], "large_number_compare_mixed_notation", "mixed_notation_prompt"],
