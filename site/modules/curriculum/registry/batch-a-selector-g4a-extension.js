...
const rows = Object.freeze([
  ...
  [g4aU08, "4A-U08", "整數四則", "kp_g4a_u08_app_add_sub_sequence", "pg_g4a_u08_app_add_sub_sequence", ["ps_g4a_u08_app_add_three_quantities", "ps_g4a_u08_app_add_then_subtract_state_change", "ps_g4a_u08_app_subtract_then_add_state_change", "ps_g4a_u08_app_subtract_twice_state_change"], "加減序列應用題", "order_of_operations_application", ["add_sub_sequence", "word_problem", "phase2a"], "add_sub_sequence_application", "word_problem_prompt"],
  [g4aU08, "4A-U08", "整數四則", "kp_g4a_u08_app_parentheses_grouping", "pg_g4a_u08_app_parentheses_grouping", ["ps_g4a_u08_app_adjusted_amount_then_subtract", "ps_g4a_u08_app_divide_by_group_product", "ps_g4a_u08_app_multiply_after_difference_then_add_sub"], "括號與組合量應用題", "order_of_operations_application", ["parentheses_grouping", "word_problem", "phase2a"], "parentheses_grouping_application", "word_problem_prompt"],
  [g4aU08, "4A-U08", "整數四則", "kp_g4a_u08_app_mul_div_sequence", "pg_g4a_u08_app_mul_div_sequence", ["ps_g4a_u08_app_multiply_then_share", "ps_g4a_u08_app_unit_rate_then_scale", "ps_g4a_u08_app_divide_then_divide"], "乘除序列應用題", "order_of_operations_application", ["mul_div_sequence", "word_problem", "phase2a"], "mul_div_sequence_application", "word_problem_prompt"],
  [g4aU08, "4A-U08", "整數四則", "kp_g4a_u08_app_mul_div_before_add_sub", "pg_g4a_u08_app_mul_div_before_add_sub", ["ps_g4a_u08_app_payment_minus_unit_cost_times_quantity", "ps_g4a_u08_app_subtract_divided_amount_or_add_divided_amount"], "乘除先於加減應用題", "order_of_operations_application", ["mul_div_before_add_sub", "word_problem", "phase2a"], "mul_div_before_add_sub_application", "word_problem_prompt"]
]);
