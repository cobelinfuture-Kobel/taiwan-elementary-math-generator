...
const rows = Object.freeze([
  ...
  [sourceIds.u06, "3A-U06", "除法", "kp_g3a_u06_exact_division_check", "pg_g3a_u06_exact_division_check", "ps_g3a_u06_exact_division_check", "三位數除以一位數整除", "integer_division_exact", ["three_digit", "one_digit", "exact_division"], "division", "numeric_expression"],
  [sourceIds.u06, "3A-U06", "除法", "kp_g3a_u06_divisibility_exact_check", "pg_g3a_u06_divisibility_exact_check", "ps_g3a_u06_divisibility_exact_check", "整除檢查", "integer_division_exact", ["divisibility", "exact_division", "check"], "division", "word_problem"]
]);
