...
const groupRows = [
  ...
  ["pg_g5a_u02_equal_partition_application","kp_g5a_u02_equal_partition_factor_application","等分情境中的因數應用",["application"],["ps_g5a_u02_equal_partition_all_segment_counts","ps_g5a_u02_equal_partition_range_constrained_recipients"],["partitionPairListAnswer","integerListWithUnitAnswer"]],
  ...
  ["pg_g5a_u02_greatest_common_factor","kp_g5a_u02_greatest_common_factor","最大公因數",["numeric"],["ps_g5a_u02_greatest_common_factor"],["commonFactorAndGcfAnswer"]],
  ...
  ["pg_g5a_u02_square_tile_areas","kp_g5a_u02_square_tile_area_possibilities","正方形磁磚面積",["geometry_application"],["ps_g5a_u02_square_tile_area_possibilities"],["tileSideAreaPairListAnswer"]],
...
const specRows = [
  ...
  ["ps_g5a_u02_greatest_common_factor","fm_g5a_u02_greatest_common_factor","fmc_g5a_u02_greatest_common_factor","pg_g5a_u02_greatest_common_factor","kp_g5a_u02_greatest_common_factor","numeric","commonFactorAndGcfAnswer","C",[],["s78:5a02a1:p1:left-top","s78:5a02a1:p1:right-top"],17,[]],
  ...
  ["ps_g5a_u02_square_tile_area_possibilities","fm_g5a_u02_square_tile_area_possibilities","fmc_g5a_u02_square_tile_area_possibilities","pg_g5a_u02_square_tile_areas","kp_g5a_u02_square_tile_area_possibilities","geometry_application","tileSideAreaPairListAnswer","D",["tpl_g5a_u02_square_tile_areas"],["s78:5a02a1:p2:left-top"],21,[]],
...
export const G5A_U02_HIDDEN_PATTERN_GROUPS = deepFreeze(groupRows.map(([
  patternGroupId, knowledgePointId, displayName, modes, patternSpecIds, answerModelIds,
]) => ({
  patternGroupId,
  unitId: G5A_U02_UNIT_ID,
  unitTitle: "因數與公因數",
...
export const G5A_U02_HIDDEN_PATTERN_SPECS = deepFreeze(specRows.map(([
  patternSpecId, formalMappingId, sourceMappingCandidateId, patternGroupId,
  knowledgePointId, mode, answerModelId, implementationClass, templateFamilyIds,
  sourceEvidence, patternOrder, qaOverlayRefs,
]) => ({
  ...sharedLifecycle,
  patternSpecId,
  formalMappingId,
...
export function getG5AU02HiddenPatternGroups() { return G5A_U02_HIDDEN_PATTERN_GROUPS; }
export function getG5AU02HiddenPatternSpecs() { return G5A_U02_HIDDEN_PATTERN_SPECS; }
export function getG5AU02HiddenPatternGroupById(patternGroupId) { return G5A_U02_HIDDEN_PATTERN_GROUPS.find((row) => row.patternGroupId === patternGroupId) ?? null; }
export function getG5AU02HiddenPatternSpecById(patternSpecId) { return G5A_U02_HIDDEN_PATTERN_SPECS.find((row) => row.patternSpecId === patternSpecId) ?? null; }
export function getG5AU02HiddenPatternSpecsByGroupId(patternGroupId) { return G5A_U02_HIDDEN_PATTERN_SPECS.filter((row) => row.patternGroupId === patternGroupId); }
