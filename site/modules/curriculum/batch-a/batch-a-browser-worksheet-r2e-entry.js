...
export function buildBatchABrowserWorksheetDocument(options={}){const result=requestsP04F35(options)?buildP04F35WorksheetDocument(options):requestsG5AU06CurrentNumericApplicationMix(options)?buildG5AU06CurrentMixedWorksheetDocument(options):requestsP04F34(options)?buildP04F34WorksheetDocument(options):baseBuild(options);return applyG5AU06StructuredFractionDisplay(result);}
