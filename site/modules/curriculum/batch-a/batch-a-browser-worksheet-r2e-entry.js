...
import {buildBatchABrowserWorksheetDocument as buildP04F16WorksheetDocument} from "./batch-a-browser-worksheet-p04f16-extension.js";
import {requestsP04F16} from "./batch-a-browser-generator-p04f16.js";
import {buildBatchABrowserWorksheetDocument as buildP04F17WorksheetDocument} from "./batch-a-browser-worksheet-p04f17-extension.js";
import {requestsP04F17} from "./batch-a-browser-generator-p04f17.js";
import {buildBatchABrowserWorksheetDocument as buildP04F18WorksheetDocument} from "./batch-a-browser-worksheet-p04f18-extension.js";
import {requestsP04F18} from "./batch-a-browser-generator-p04f18.js";
export function buildBatchABrowserWorksheetDocument(options={}){return requestsP04F18(options)?buildP04F18WorksheetDocument(options):requestsP04F17(options)?buildP04F17WorksheetDocument(options):requestsP04F16(options)?buildP04F16WorksheetDocument(options):requestsP04F15(options)?buildP04F15WorksheetDocument(options):requestsP04F14(options)?buildP04F14WorksheetDocument(options):requestsP04F13(options)?buildP04F13WorksheetDocument(options):requestsP04F12(options)?buildP04F12WorksheetDocument(options):requestsP04F11(options)?buildP04F11WorksheetDocument(options):buildP04F10R2EWorksheetDocument(options);}
