...
const CONVERSION_SPEC_SET = new Set(G3B_U07_FRACTION_UNIT_CONVERSION_NUMERIC_SPEC_IDS);
...
export function requestsG3BU07CurrentWorksheet(options = {}) {
  ...
  return String(options.questionMode ?? options.requestedQuestionType ?? "numeric") !== "application";
}
...
export function buildG3BU07CurrentPlan(options = {}) {
  ...
  return Object.freeze({
    ...
    patternSpecIds: Object.freeze(selected.flatMap((id) => SPEC_IDS_BY_KP[id] ?? [])),
    questionCount: count,
...
export function validateG3BU07CurrentPlan(plan = {}) {
  ...
  if (plan.questionMode !== "numeric") errors.push(issue("g3b_u07_current_question_mode_invalid", "questionMode"));
