import {buildBatchABrowserPlan as baseBuildPlan,generateBatchABrowserQuestions as baseGenerate} from "./batch-a-browser-generator-p07f25.js";
import {generateG6AU08P07F26Questions,G6A_U08_P07F26_MAX_QUESTION_COUNT} from "./g6a-u08-effective-speed-current-wind-runtime-p07f26.js";
import {G6A_U08_P07F26_KP_ID as KP,G6A_U08_P07F26_PATTERN_GROUP as GROUP,G6A_U08_P07F26_PATTERN_SPECS as SPECS,G6A_U08_P07F26_SOURCE_ID as SRC,G6A_U08_P07F26_SPEC_IDS as SPEC_IDS} from "../registry/g6a-u08-effective-speed-current-wind-selector-projection-p07f26.js";
const BY_SPEC=new Map(SPECS.map(x=>[x.patternSpecId,x]));
export function requestsP07F26(o={}){
...
export function buildBatchABrowserPlan(o={}){
  if(!requestsP07F26(o))return baseBuildPlan(o);
  ...
  return Object.freeze({...base,sourceId:SRC,sourceUnit:Object.freeze({sourceId:SRC,grade:6,semester:"upper",unitCode:"6A-U08",title:"認識速率",domain:"speed_rate"}),
    ...
    questionMode:"numeric",requestedQuestionType:"numeric",questionCount:Number.isInteger(o.questionCount)?o.questionCount:20,questionCountMax:G6A_U08_P07F26_MAX_QUESTION_COUNT,
    generationSeed:String(o.generationSeed??"p07f26-effective-speed-current-wind"),
    publicControls:Object.freeze({sourceId:SRC,questionMode:"numeric",requestedQuestionType:"numeric",productWave:"P07F",productAdmissionTask:"P07F_W7DirectProductVerticalSlice026Implementation"}),
    publicPatternSpecInjectionUsed:false,genericFallback:false,genericFallbackAllowed:false,freeFormAI:false,
    applicationContextMode:"SOURCE_BACKED_EFFECTIVE_SPEED_CURRENT_WIND",sameUnitMixedMode:"NOT_ADMITTED",sharedRuntimeScope:"SHARED_RUNTIME_BOUNDED",
    frozenRuntimeProfile:"profile_speed_rate",finalFrozenW7Slice:true});
}
export const buildBatchABrowserGenerationPlan=buildBatchABrowserPlan;
export function generateBatchABrowserQuestions(o={}){
  if(!requestsP07F26(o))return baseGenerate(o);
  const plan=buildBatchABrowserPlan(o),generated=generateG6AU08P07F26Questions({...plan,knowledgePointId:KP});
