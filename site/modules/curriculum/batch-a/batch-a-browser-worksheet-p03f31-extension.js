...
import { buildBatchABrowserWorksheetDocument as baseBuild } from "./batch-a-browser-worksheet-p03f30-extension.js";
import { buildBatchABrowserPlan, requestsP03F31 } from "./batch-a-browser-generator-p03f31.js";
import { generateBatchABrowserQuestions } from "./batch-a-browser-question-router-p03f31.js";
import { validateBatchABrowserPlan, validateBatchABrowserQuestions } from "./batch-a-browser-validator-p03f31.js";
import {
...
export const P03F31_WORKSHEET_ADAPTER = Object.freeze({
  task: "P03F_W3DirectProductVerticalSlice031Implementation",
  status: "bounded_shared_decimal_times_integer_source_connected",
...
export function buildBatchABrowserWorksheetDocument(options = {}) {
  if (!requestsP03F31(options)) return baseBuild(options);
  ...
  const models = generation.questions.map((question, index) => Object.freeze({
    ...
    layoutHints: Object.freeze({ estimatedTextLength:question.blankedDisplayText.length, hasGrouping:false, avoidPageBreakInside:true, representation:"decimal_multiplication_numeric", longTextCardPolicy:"avoidSplit" }),
  }));
  const answers = layout.showAnswerKeyPage ? generation.questions.map((question, index) => Object.freeze({
    ...
    answerText: question.answerText,
    metadataSnapshot: question.metadata,
    layoutHints: Object.freeze({ avoidPageBreakInside:true, representation:"decimal_multiplication_numeric_answer" }),
  })) : [];
  ...
  const document = Object.freeze({
    ...
    version:"1",
    worksheetId:`p03f31-g5b-u04-decimal-times-integer-${plan.questionCount}-${plan.generationSeed}`,
    worksheetKind:"batchAWorksheet",
    title: options.title ?? "五年級下｜小數的乘法｜小數乘以整數",
    subtitle:"三位小數乘以正整數",
    ...
    publicControls:Object.freeze({ sourceId:G5B_U04_P03F31_SOURCE_ID, questionMode:"numeric", productAdmissionTask:P03F31_WORKSHEET_ADAPTER.task, globalContextRegistry:null }),
    metadata:Object.freeze({ sourceId:G5B_U04_P03F31_SOURCE_ID, knowledgePointIds:Object.freeze([G5B_U04_P03F31_KP_ID]), applicationExpansion:false, worksheetAdapter:P03F31_WORKSHEET_ADAPTER }),
    batchA:Object.freeze({ sourceId:G5B_U04_P03F31_SOURCE_ID, questionMode:"numeric", selectionMode:plan.selectionMode }),
  ...
  return Object.freeze({ ok:true, errors:Object.freeze([]), warnings:Object.freeze([]), worksheetDocument:document, plan, generation, validation, p03f31WorksheetAdapter:P03F31_WORKSHEET_ADAPTER });
}

export const P03F31_CURRENT_ADDED_KP_IDS = Object.freeze([G5B_U04_P03F31_KP_ID]);
export const P03F31_CURRENT_ADDED_SPEC_IDS = Object.freeze([G5B_U04_P03F31_SPEC_ID]);
