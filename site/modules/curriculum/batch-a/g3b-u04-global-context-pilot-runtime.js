...
export const G3B_U04_GLOBAL_CONTEXT_PILOT_AUTHORITY_DOMAINS = Object.freeze([
  "food",
  "school_supplies",
  "tickets",
  "equipment_rental"
...
const authorityDomainSet = new Set(G3B_U04_GLOBAL_CONTEXT_PILOT_AUTHORITY_DOMAINS);
...
export const G3B_U04_GLOBAL_CONTEXT_PILOT_RUNTIME = Object.freeze({
  ...
  authorityContextDomains: G3B_U04_GLOBAL_CONTEXT_PILOT_AUTHORITY_DOMAINS
});
...
export function normalizeG3BU04GlobalContextPilotPlan(plan = {}, options = {}) {
  ...
  return {
    ...
    globalContextPilot: {
      ...
      enabled: true,
      variantIds,
      allowedAuthorityContextDomains: [...G3B_U04_GLOBAL_CONTEXT_PILOT_AUTHORITY_DOMAINS],
...
export function applyG3BU04GlobalContextPilotQuestion(question = {}, options = {}, sequenceNumber = 1) {
  ...
  const authorityContextDomain = question.contextDomain;
...
export function validateG3BU04GlobalContextPilotRuntimeQuestion(question = {}) {
  ...
  if (!authorityDomainSet.has(question.contextDomain)
    || pilot.authorityContextDomain !== question.contextDomain) {
    errors.push(issue(
      "GCTX_P12R_AUTHORITY_DOMAIN_INVALID",
      "contextDomain",
      "Pilot must preserve the exact authority context domain generated by the canonical base question.",
