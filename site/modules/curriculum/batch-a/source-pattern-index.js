...
export const BATCH_A_BROWSER_PATTERN_DEFINITIONS = Object.freeze({
  ...
  ps_g4a_u01_digit_arrangement_max_min: g4aU01ReasoningPattern({ patternSpecId: "ps_g4a_u01_digit_arrangement_max_min", title: "指定數字排列最大最小", kind: "g4aU01DigitArrangementMaxMin", canonicalSkillId: "place_value_reasoning", skillTags: ["place_value_reasoning", "digit_arrangement", "max_min", "no_leading_zero"], answerModel: { shape: "max_min_pair", fields: ["maxNumber", "minNumber"] }, min: 10000, max: 99999 }),
