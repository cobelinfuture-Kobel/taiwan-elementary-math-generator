...
const PROMPTS=Object.freeze([
  ...
  ["smaller_capacity","容量較小時應直接選哪個單位？"],
  ["larger_capacity","容量較大時應直接選哪個單位？"],
  ["smaller_capacity","只判斷單位適用尺度：小容量對應哪個單位？"],
  ["larger_capacity","只判斷單位適用尺度：大容量對應哪個單位？"],
