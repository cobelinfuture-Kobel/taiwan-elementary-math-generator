...
const q049=W5_SLICE049_PUBLIC_SOURCE_UNITS[0],qW6_001=W6_SLICE001_PUBLIC_SOURCE_UNITS[0],qW6_003=W6_SLICE003_PUBLIC_SOURCE_UNITS[0],qW6_005=W6_SLICE005_PUBLIC_SOURCE_UNITS[0],qW6_007=W6_SLICE007_PUBLIC_SOURCE_UNITS[0],qW6_010=W6_SLICE010_PUBLIC_SOURCE_UNITS[0],qW6_014=W6_SLICE014_PUBLIC_SOURCE_UNITS[0],qW6_015=W6_SLICE015_PUBLIC_SOURCE_UNITS[0];
...
export function getBatchASourceUnit(sourceId){if(sourceId===qW6_015.sourceId)return {...qW6_015};if(sourceId===qW6_014.sourceId)return {...qW6_014};if(sourceId===qW6_010.sourceId)return {...qW6_010};if(sourceId===qW6_007.sourceId)return {...qW6_007};if(sourceId===qW6_005.sourceId)return {...qW6_005};if(sourceId===qW6_003.sourceId)return {...qW6_003};if(sourceId===qW6_001.sourceId)return {...qW6_001};return sourceId===q049.sourceId?{...q049}:base.getBatchASourceUnit(sourceId);}
export function isBatchASourceId(sourceId){return sourceId===qW6_015.sourceId||sourceId===qW6_014.sourceId||sourceId===qW6_010.sourceId||sourceId===qW6_007.sourceId||sourceId===qW6_005.sourceId||sourceId===qW6_003.sourceId||sourceId===qW6_001.sourceId||sourceId===q049.sourceId||base.isBatchASourceId(sourceId);}
