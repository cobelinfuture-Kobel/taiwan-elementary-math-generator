...
export function listCurrentFullProductPublicSourceUnits() { return (typeof document !== "undefined" ? P04F4_BROWSER_CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS : CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS).map((unit) => ({ ...unit })); }
