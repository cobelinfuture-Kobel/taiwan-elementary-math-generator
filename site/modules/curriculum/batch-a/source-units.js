...
export const W4_SLICE002_PUBLIC_SOURCE_UNITS = Object.freeze([Object.freeze({ sourceId: "g3b_u02_3b02", grade: 3, semester: "lower", unitCode: "3B-U02", title: "公升與毫升", domain: "quantity_measurement", lifecycle: "public_full_product_w4_slice002_candidate" })]);
export const W4_SLICE003_PUBLIC_SOURCE_UNITS = Object.freeze([Object.freeze({ sourceId: "g3b_u03_3b03", grade: 3, semester: "lower", unitCode: "3B-U03", title: "時間", domain: "time", lifecycle: "public_full_product_w4_slice003_candidate" })]);
export const W4_SLICE004_PUBLIC_SOURCE_UNITS = Object.freeze([Object.freeze({ sourceId: "g3b_u06_3b06", grade: 3, semester: "lower", unitCode: "3B-U06", title: "公斤與公克", domain: "quantity_measurement", lifecycle: "public_full_product_w4_slice004_candidate" })]);
export const W4_SLICE005_PUBLIC_SOURCE_UNITS = Object.freeze([Object.freeze({ sourceId: "g4a_u10_4a10", grade: 4, semester: "upper", unitCode: "4A-U10", title: "公里", domain: "quantity_measurement", lifecycle: "public_full_product_w4_slice005_candidate" })]);
...
export const P03F31_FULL_PRODUCT_PUBLIC_SOURCE_UNITS = Object.freeze([...P03F30_FULL_PRODUCT_PUBLIC_SOURCE_UNITS, ...W3_SLICE031_PUBLIC_SOURCE_UNITS]);
export const P03F32_FULL_PRODUCT_PUBLIC_SOURCE_UNITS = Object.freeze([...P03F31_FULL_PRODUCT_PUBLIC_SOURCE_UNITS, ...W3_SLICE032_PUBLIC_SOURCE_UNITS]);
...
const P04F5_BROWSER_CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS = Object.freeze([...CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS, ...W4_SLICE001_PUBLIC_SOURCE_UNITS, ...W4_SLICE002_PUBLIC_SOURCE_UNITS, ...W4_SLICE003_PUBLIC_SOURCE_UNITS, ...W4_SLICE004_PUBLIC_SOURCE_UNITS, ...W4_SLICE005_PUBLIC_SOURCE_UNITS]);
const HISTORICAL_SOURCE_UNIT_BY_ID = new Map(CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS.map((unit) => [unit.sourceId, unit]));
const BROWSER_SOURCE_UNIT_BY_ID = new Map(P04F5_BROWSER_CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS.map((unit) => [unit.sourceId, unit]));
function sourceUnitMap() { return typeof document !== "undefined" ? BROWSER_SOURCE_UNIT_BY_ID : HISTORICAL_SOURCE_UNIT_BY_ID; }
export function listBatchASourceUnits(options = {}) { const browserDefault = typeof document !== "undefined"; const includePublicCandidates = options.includePublicCandidates ?? browserDefault; const includeFullProductPublic = options.includeFullProductPublic ?? (browserDefault && options.includePublicCandidates === undefined); const includeCurrentFullProductPublic = options.includeCurrentFullProductPublic ?? options.includeW3Slice001 ?? (browserDefault && options.includeFullProductPublic === undefined && options.includePublicCandidates === undefined); const currentUnits = browserDefault ? P04F5_BROWSER_CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS : CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS; const units = includeFullProductPublic ? (includeCurrentFullProductPublic ? currentUnits : P01E_FULL_PRODUCT_PUBLIC_SOURCE_UNITS) : includePublicCandidates ? PROTECTED_FIFTEEN_PUBLIC_SOURCE_UNITS : BATCH_A_SOURCE_UNITS; return units.map((unit) => ({ ...unit })); }
...
export function listCurrentFullProductPublicSourceUnits() { return (typeof document !== "undefined" ? P04F5_BROWSER_CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS : CURRENT_FULL_PRODUCT_PUBLIC_SOURCE_UNITS).map((unit) => ({ ...unit })); }
