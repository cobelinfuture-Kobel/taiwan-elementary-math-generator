...
sourceSelect?.addEventListener("change", syncPublicControlUi);
selectionModeSelect?.addEventListener("change", syncPublicControlUi);
for (const select of [questionSelect, depthSelect, contextSelect]) {
  select?.addEventListener("change", syncPublicControlUi);
}
